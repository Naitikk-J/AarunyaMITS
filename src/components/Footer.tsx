...
const Footer = () => {
  return (
    <footer className="relative py-16 px-4 overflow-hidden" id="contact">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="bg-crt-black p-8 md:p-12">
            ...
            {/* Bottom bar */}
            <div className="mt-8 pt-6 border-t-4 border-muted flex flex-col md:flex-row items-center justify-between gap-4">
