...
export const TVZoom: React.FC<TVZoomProps> = ({ children }) => {
    ...
    const combinedOpacity = useTransform(scrollYProgress, [0, 0.2, 0.4, 0.9], [1, 0.3, 0.1, 0]);
    ...
    return (
        <div ref={containerRef} className="relative h-[100vh] md:h-[200vh] w-full">
            <div className="sticky top-16 md:top-24 h-[calc(100vh-4rem)] md:h-[calc(100vh-6rem)] w-full flex items-center justify-center ">
                <motion.div
                    style={{
                        scale,
