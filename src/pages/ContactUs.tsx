    ...
    <div className="min-h-screen bg-[#05010D] text-white font-orbitron selection:bg-primary selection:text-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {contacts.map((c) => (
            <div key={c.title} className="relative bg-[#0D0221]/60 border-2 border-white/5 rounded-xl p-6 sm:p-8">
              <Badge className="absolute top-4 right-4 bg-primary text-black text-[11px] tracking-widest px-3 py-1">
                {c.channel}
              </Badge>
              ...
              <div className="space-y-5">
                ...
                <p className="font-share-tech text-xs sm:text-[14px] text-white/40 tracking-[0.2em] uppercase">
                  {c.description}
                </p>
                ...
                <div className="space-y-3 pt-4 border-t border-white/5">
                  {c.items.map((item) => (
                    <div key={item} className="flex items-center gap-3">
                      ...
                      <span className="text-xs sm:text-[13px] tracking-widest">
                        {item}
                      </span>
                    </div>
                  ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-[#0D0221]/60 border-2 border-white/5 rounded-xl p-6 sm:p-10">
            <Badge className="bg-primary text-black text-[11px] tracking-widest px-3 py-1 mb-6">
              TRANSMISSION
            </Badge>
            ...
            <p className="text-xs sm:text-[13px] text-white/40 tracking-[0.25em] uppercase mb-8">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label className="text-xs tracking-[0.25em] uppercase text-white/40">
                    PLAYER_ID
                  </Label>
                  <Input className="h-12 bg-black/40 border-white/10" />
                </div>
                <div>
                  <Label className="text-xs tracking-[0.25em] uppercase text-white/40">
                    COMM_NODE
                  </Label>
                  <Input type="email" className="h-12 bg-black/40 border-white/10" />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea className="w-full min-h-[140px] bg-black/40 border border-white/10 rounded-lg p-4 resize-none" />
              </div>

              <Button className="w-full h-14 text-base tracking-[0.25em] font-bold">
                SEND SIGNAL
              </Button>
            </form>
          </div>
          ...
          <div className="space-y-8">
            {/* SOCIAL */}
            <div className="bg-[#0D0221]/60 border-2 border-white/5 rounded-xl p-6 sm:p-10">
              <Badge className="bg-secondary text-black text-[11px] tracking-widest px-3 py-1 mb-6">
                SOCIAL NETWORK
              </Badge>

              <div className="grid grid-cols-2 gap-4">
                {socials.map((s) => (
                  <div key={s.label} className="bg-black/40 border border-white/5 rounded-lg p-4 sm:p-6 text-center">
            ...
            {/* SIGNAL */}
            <div className="bg-[#0D0221]/60 border-2 border-white/5 rounded-xl p-6 flex flex-col sm:flex-row justify-between gap-4">
              <div className="flex items-center gap-3">
                <span className="text-xs tracking-[0.25em] uppercase text-white/40">
                  SIGNAL STRENGTH
                </span>
                <span className="text-secondary font-bold tracking-[0.2em]">
                  MAXIMUM
                </span>
              </div>
            ...
            <div className="bg-[#0D0221]/60 border-2 border-white/5 rounded-xl p-6 flex items-center gap-4">
              ...
              <div>
                <div className="text-xs tracking-[0.3em] uppercase text-white/30">
                  LOCATION
                </div>
                <div className="font-bold">MITS GWALIOR, MP</div>
                <div className="text-xs tracking-[0.2em] uppercase text-primary/60">
