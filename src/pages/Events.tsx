...
const Events = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-primary selection:text-black font-pixel">
      ...
      {/* Header */}
      <div className="relative pt-32 pb-16 overflow-hidden border-b-4 border-primary/20">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(188,19,254,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(188,19,254,0.05)_1px,transparent_1px)] bg-[size:40px_40px]" />
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-pixel text-primary mb-4 glow-pink uppercase tracking-tighter">
            MISSION_SELECT
          </h1>
      ...
      <div className="container mx-auto px-6 py-20 space-y-32">
        {zones.map((zone, idx) => (
          <div key={zone.title} className="relative group">
            {/* Background Accent */}
            <div className={`absolute -inset-4 bg-primary/5 border-2 border-dashed border-primary/20 -z-10 transition-all group-hover:bg-primary/10`} />
            
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              {/* Zone Info */}
              <div className="lg:col-span-5 space-y-6">
                <div className="inline-block px-4 py-1 bg-primary text-black text-[10px] font-bold mb-4">
                  ZONE_0{idx + 1}
                </div>
                <h2 className="text-3xl text-primary glow-pink tracking-tighter uppercase">
                  {zone.title}
                </h2>
                ...
                <div className="pt-4">
                  <div className="h-1 w-full bg-white/5 relative overflow-hidden">
                    <div className="absolute inset-0 bg-primary/40 animate-[loading_3s_ease-in-out_infinite]" />
                  </div>
                </div>
              </div>
                ...
                {zone.events.map((event) => (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="text-lg text-white group-hover/card:text-primary transition-colors tracking-tight">
                        {event.name}
                      </div>
                      ...
                      <button className="text-[10px] text-primary border-b border-primary pb-0.5 hover:opacity-80 transition-opacity uppercase">
                        View Details_
                      </button>
                    </div>
                  </div>
