    ...
    <div className="min-h-screen bg-[#05010D] text-white font-vt323 selection:bg-primary selection:text-black">
      ...
      <div className="content-scale">
        ...
        <div className="relative pt-28 sm:pt-32 md:pt-40 pb-16 sm:pb-20 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20 mb-4 sm:mb-6">
            REGISTER
          </h1>

          <div className="h-1 w-24 sm:w-[120px] bg-primary mx-auto shadow-neon" />

          <p className="mt-6 sm:mt-8 text-xs sm:text-sm md:text-base font-vt323 text-muted-foreground opacity-60 max-w-3xl mx-auto px-4 sm:px-6 leading-relaxed">
            ...
            <div className="relative bg-[#0D0221]/60 backdrop-blur-xl border-2 border-white/5 rounded-xl overflow-hidden hover:border-primary/30 shadow-[0_0_30px_rgba(188,19,254,0.05)] transition-all duration-500 p-6 sm:p-8 md:p-10">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center mb-8 sm:mb-10">
                  <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 drop-shadow-[0_0_20px_rgba(188,19,254,0.4)]">
                    🎮
                  </div>
                  ...
                  <p className="font-vt323 text-[12px] sm:text-[14px] text-white/40 mt-4 uppercase tracking-normal">
                ...
                <form className="space-y-5 sm:space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="space-y-2 group">
                    <Label className="font-vt323 text-[14px] sm:text-[15px] text-white/40 group-focus-within:text-primary transition-colors uppercase">
                      Username
                    </Label>
                    <Input
                      className="bg-black/40 border border-white/10 focus:border-primary rounded-lg font-vt323 text-sm h-11 sm:h-12 transition-all placeholder:text-white/20"
                  ...
                  <Button className="w-full bg-primary text-black font-orbitron text-[16px] sm:text-[18px] h-12 sm:h-14 rounded-lg border-none shadow-neon hover:shadow-[0_0_30px_rgba(188,19,254,0.4)] transition-all tracking-[0.2em] sm:tracking-[0.3em] font-bold">
                    INITIALIZE ACCOUNT
                  </Button>
                </form>
                ...
                <div className="mt-6 sm:mt-8 text-center border-t border-white/5 pt-5 sm:pt-6">
                  <div className="flex items-center justify-center gap-3 sm:gap-4">
                    <span className="font-vt323 text-[15px] sm:text-[17px] text-white/30 uppercase">
                      System Status
                    </span>
                    <span className="flex items-center gap-2">
                      <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                      <span className="font-vt323 text-[15px] sm:text-[17px] text-secondary font-bold">
                        Online
                      </span>
                    </span>
                  </div>
